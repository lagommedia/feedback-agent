...
import type { FeedbackItem, FeedbackType, UrgencyLevel } from '@/types'
...
export function FeedbackDrawer({ item, open, onClose }: FeedbackDrawerProps) {
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border shrink-0">
          <div>
            <h2 className="text-base font-semibold">Send Feedback to AI</h2>
            <p className="text-xs text-muted-foreground mt-0.5">
              Your note will be formatted by Claude and added to the AI instructions.
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full min-h-[140px] rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring resize-y"
                disabled={saved}
              />
            </div>
